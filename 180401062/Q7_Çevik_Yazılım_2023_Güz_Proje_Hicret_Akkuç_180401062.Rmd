...
Bu proje kapsamında, fıstık ezmesi şirketiniz için pratik ve fıstık ezmesi içeren tarifleri filtreledim. İncelediğim sonuçlar, Instagram hesabınıza ekleyebileceğiniz çeşitli pratik ve lezzetli tarifleri içermekte. Bu filtrelenmiş tarifler arasından istediğinizi seçerek, tarif videolarınızı çekmek için kullanabilir ve instagram hesabınızı canlandırarak satışlarınızı arttırabilirsiniz. Verileri incelediğimde fıstık ezmesi kullanılarak yapılan tarif sayısının çok da fazla olmadığını gördüm, tariflerin yetersiz kalması durumunda farklı datasetleri için de aynı veya farklı analizleri uygulayabilirim. Örneğin kullanıcı yorumları içeren bir dataset ile en çok beğenilen ve fıstık ezmesiyle yapılan tarifleri bulabilirim. Yani ihtiyacınıza göre istediğiniz özellikteki fıstık ezmesi tariflerinin analizlerini yapabilirim. Daha fazla tarife ihtiyaç duymanız durumunda benimle iletişime geçebilirsiniz.
